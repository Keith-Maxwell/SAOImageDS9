...
tkimggif_VERSION='1.4.9'

# The name of the tkimggif library (may be either a .a file or a shared library):
tkimggif_LIB_FILE=libtkimggif1.4.9.a

# String to pass to linker to pick up the tkimggif library from its
# build directory.
tkimggif_BUILD_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/tkimg/gif -ltkimggif1.4.9'

# String to pass to linker to pick up the tkimggif library from its
# installed directory.
tkimggif_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/lib/tkimggif1.4.9 -ltkimggif1.4.9'
