...
tkimgwindow_VERSION='1.4.9'

# The name of the tkimgwindow library (may be either a .a file or a shared library):
tkimgwindow_LIB_FILE=libtkimgwindow1.4.9.a

# String to pass to linker to pick up the tkimgwindow library from its
# build directory.
tkimgwindow_BUILD_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/tkimg/window -ltkimgwindow1.4.9'

# String to pass to linker to pick up the tkimgwindow library from its
# installed directory.
tkimgwindow_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/lib/tkimgwindow1.4.9 -ltkimgwindow1.4.9'
