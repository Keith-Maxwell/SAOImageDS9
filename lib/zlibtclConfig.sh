...
zlibtcl_LIB_FILE=libzlibtcl1.2.11.a

# String to pass to linker to pick up the zlibtcl library from its
# build directory.
zlibtcl_BUILD_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/tkimg/zlib -lzlibtcl1.2.11'

# String to pass to linker to pick up the zlibtcl library from its
# installed directory.
zlibtcl_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/lib/zlibtcl1.2.11 -lzlibtcl1.2.11'

# The name of the zlibtcl stub library (a .a file):
zlibtcl_STUB_LIB_FILE=libzlibtclstub1.2.11.a

# String to pass to linker to pick up the zlibtcl stub library from its
# build directory.
zlibtcl_BUILD_STUB_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/tkimg/zlib -lzlibtclstub1.2.11'

# String to pass to linker to pick up the zlibtcl stub library from its
# installed directory.
zlibtcl_STUB_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/lib/zlibtcl1.2.11 -lzlibtclstub1.2.11'

# String to pass to linker to pick up the zlibtcl stub library from its
# build directory.
zlibtcl_BUILD_STUB_LIB_PATH='/home/max/Programming/SAOImageDS9/tkimg/zlib/libzlibtclstub1.2.11.a'

# String to pass to linker to pick up the zlibtcl stub library from its
# installed directory.
zlibtcl_STUB_LIB_PATH='/home/max/Programming/SAOImageDS9/lib/zlibtcl1.2.11/libzlibtclstub1.2.11.a'
