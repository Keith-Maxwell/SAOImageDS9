...
tifftcl_LIB_FILE=libtifftcl3.9.7.a

# String to pass to linker to pick up the tifftcl library from its
# build directory.
tifftcl_BUILD_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/tkimg/libtiff -ltifftcl3.9.7'

# String to pass to linker to pick up the tifftcl library from its
# installed directory.
tifftcl_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/lib/tifftcl3.9.7 -ltifftcl3.9.7'
...
# build directory.
tifftcl_BUILD_STUB_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/tkimg/libtiff -ltifftclstub3.9.7'

# String to pass to linker to pick up the tifftcl stub library from its
# installed directory.
tifftcl_STUB_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/lib/tifftcl3.9.7 -ltifftclstub3.9.7'

# String to pass to linker to pick up the tifftcl stub library from its
# build directory.
tifftcl_BUILD_STUB_LIB_PATH='/home/max/Programming/SAOImageDS9/tkimg/libtiff/libtifftclstub3.9.7.a'

# String to pass to linker to pick up the tifftcl stub library from its
# installed directory.
tifftcl_STUB_LIB_PATH='/home/max/Programming/SAOImageDS9/lib/tifftcl3.9.7/libtifftclstub3.9.7.a'
