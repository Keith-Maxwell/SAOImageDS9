...
# installed.
TK_PREFIX='/home/max/Programming/SAOImageDS9'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/home/max/Programming/SAOImageDS9'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/tk8.6/unix -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/home/max/Programming/SAOImageDS9/include'
...
# compiled.
TK_SRC_DIR='/home/max/Programming/SAOImageDS9/tk8.6'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/tk8.6/unix -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/home/max/Programming/SAOImageDS9/tk8.6/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/home/max/Programming/SAOImageDS9/lib/libtkstub8.6.a'
