...
tkimg_LIB_FILE=libtkimg1.4.9.a

# String to pass to linker to pick up the tkimg library from its
# build directory.
tkimg_BUILD_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/tkimg/base -ltkimg1.4.9'

# String to pass to linker to pick up the tkimg library from its
# installed directory.
tkimg_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/lib/tkimg1.4.9 -ltkimg1.4.9'

# The name of the tkimg stub library (a .a file):
tkimg_STUB_LIB_FILE=libtkimgstub1.4.9.a

# String to pass to linker to pick up the tkimg stub library from its
# build directory.
tkimg_BUILD_STUB_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/tkimg/base -ltkimgstub1.4.9'

# String to pass to linker to pick up the tkimg stub library from its
# installed directory.
tkimg_STUB_LIB_SPEC='-L/home/max/Programming/SAOImageDS9/lib/tkimg1.4.9 -ltkimgstub1.4.9'

# String to pass to linker to pick up the tkimg stub library from its
# build directory.
tkimg_BUILD_STUB_LIB_PATH='/home/max/Programming/SAOImageDS9/tkimg/base/libtkimgstub1.4.9.a'

# String to pass to linker to pick up the tkimg stub library from its
# installed directory.
tkimg_STUB_LIB_PATH='/home/max/Programming/SAOImageDS9/lib/tkimg1.4.9/libtkimgstub1.4.9.a'
